...
export const getFullYear = arg => moment(arg).format('YYYY-MM-DD');
export const getDayMon = arg => moment(arg).format('DD/MM');
export const getHourMin = arg => moment(arg).format('HH:mm');
